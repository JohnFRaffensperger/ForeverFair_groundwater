...
CREATE TABLE IF NOT EXISTS auctions (auction_id TEXT PRIMARY KEY, label TEXT NOT NULL, bid_close_label TEXT NOT NULL, status TEXT NOT NULL, created_at TEXT NOT NULL, ran_at TEXT );
