...
import SetupForeverFairDB as db_setup
...
repository = AuctionRepository(db_path=DATA_DIR / "foreverfair.db", debug_db_path=DATA_DIR / "small_debug_database.db",)
...
def manager_run_auction(auction_id: str = Form(...)):
	...
	try:
		...
		try: AuctionController.apply_default_bounds(repository, auction_id)
